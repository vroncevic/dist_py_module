...
Info
    Defines a DistPyModuleBundle bundle for the CLI application.
'''
...
class DistPyModuleBundle:
    '''
        DistPyModuleBundle holding all components (adapters and services) of the CLI application.
    ...
    def merge(self, other: 'DistPyModuleBundle') -> None:
        '''
            Merges non-None values from another bundle into this one.

            :param other: Another bundle to merge into this one.
            :type other: <DistPyModuleBundle>
            :exceptions: None.
        '''
